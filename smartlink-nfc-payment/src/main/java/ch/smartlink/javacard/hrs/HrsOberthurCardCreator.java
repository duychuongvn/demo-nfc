...
public class HrsOberthurCardCreator {
...
//    private ByteArray keyMFCardMgmtUpdated = new ByteArray("03 13 23 33 73 73 73 73 73 73 73 73 73 73 73 73");
    ...
    private IAes aes;
    public HrsOberthurCardCreator(ICommsChannel commsChannel, IAes aes, Logger logger) throws CipurseException {
    ...
    private void updateMFFileAttribute() throws CipurseException {
        connect();
        if(!isNotCardInitialized()) {
            ...
            SMR smrMF = new SMR();
            smrMF.SMGroup_1 = SMR.SM_PLAIN_PLAIN;
            smrMF.SMGroup_2 = SMR.SM_PLAIN_PLAIN;
            smrMF.SMGroup_3 = SMR.SM_PLAIN_PLAIN;
            smrMF.SMGroup_4 = SMR.SM_PLAIN_PLAIN;

            ART[] artMF = new ART[9];
            for (int i=0; i<artMF.length;i++) {
                artMF[i] = new ART(0x01);
            }
            ...
            SecurityAttributes mfFileAtribute = new SecurityAttributes(smrMF, artMF);

            ByteArray response = cipurseOperational.updateFileAttributes(mfFileAtribute);
...
//        cipurseCardHandler.secureMessagingIndicator = CipurseCardHandler.SMI_ENC_ENC_LE_PRESENT;
      //  cipurseCardHandler.secureMessagingIndicator = CipurseCardHandler.SMI_PLAIN_PLAIN_LE_PRESENT;
...
//        smrCardInfo.SMGroup_4 = SMR.SM_ENC_MAC; // UPDATE FILE ATTRIBUTE
        ...
        smrCardInfo.SMGroup_1 = SMR.SM_PLAIN_PLAIN; // READ BINARY
        smrCardInfo.SMGroup_2 = SMR.SM_PLAIN_PLAIN; // UPDATE BINARY
        smrCardInfo.SMGroup_3 = SMR.SM_PLAIN_PLAIN; // READ FILE ATTRIBUTE
        smrCardInfo.SMGroup_4 = SMR.SM_PLAIN_PLAIN; // UPDATE FILE ATTRIBUTE
    ...
    private void createADF() throws CipurseException {
        ...
        personalizeKeyInfo.kvv = new ByteArray("FC 4B 20").getBytes();
        ...
        smrADf.SMGroup_2 = SMR.SM_PLAIN_PLAIN; // UPDATE_KEY, UPDATE_KEY_ATTRIBUTES
        smrADf.SMGroup_3 = SMR.SM_PLAIN_PLAIN; // READ_FILE_ATTRIBUTES
        smrADf.SMGroup_4 = SMR.SM_PLAIN_PLAIN   ; // UPDATE_FILE_ATTRIBUTES, CREATE_FILE (EF)
